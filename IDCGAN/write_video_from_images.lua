...
op:option{'-d', '--dir', action='store', dest='dir', help='directory to load', req=true, default="./results/rain/450_net_G_training_mr/images/output"}
...
for i,file in ipairs(files) do
   ...
   imagePath= file -- "./datasets/rain/training_mr/noise/raindrop0001.jpg"
